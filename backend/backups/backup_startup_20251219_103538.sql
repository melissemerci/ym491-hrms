...
\restrict MGbBdyftuEKD6LSWdwDTdRJkqjV5HrDxcqWL5HJXgJSqeegYcfsauNcosd9ecKx
...
35	2	Candidate		\N	/api/io/cv-application/files/20251219_092903_cedf0036_furkan-ulutas-cv.pdf	\N	\N	\N	Career Page	New	2025-12-19 09:32:10.91971+00	\N	applied	2025-12-19 09:32:10.91971+00	\N	\N	f	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
36	2	Furkan Ulutaş	furkanulutas054@gmail.com	+905399225570	/api/io/cv-application/files/20251219_093602_149d28ee_furkan-ulutas-cv.pdf	\N	\N	https://www.linkedin.com/in/Furkan-Ulutas	Career Page	New	2025-12-19 09:42:13.57285+00	\N	applied	2025-12-19 09:42:13.57285+00	\N	\N	f	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
37	2	Muhammet Şahin Yıldırım	muhammetsahinyildirim@gmail.com	+905067002739	/api/io/cv-application/files/20251219_100008_3a614805_Muhammet_Sahin_Yildirim_CV_.pdf	\N	\N	https://www.linkedin.com/in/muhammetsahinyildirim	Career Page	New	2025-12-19 10:01:38.380336+00	\N	applied	2025-12-19 10:01:38.380336+00	\N	\N	f	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
...
39	2	Furkan Ulutaş	furkanulutas054@gmail.com	+905399225570	/api/io/cv-application/files/20251219_102844_de0f0c2a_furkan-ulutas-cv.pdf	\N	\N	https://www.linkedin.com/in/furkan-ulutas	Career Page	New	2025-12-19 10:29:30.965003+00	\N	applied	2025-12-19 10:29:30.965003+00	\N	\N	f	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public.candidate_additional_info_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.candidate_addresses_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.candidate_awards_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.candidate_certifications_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.candidate_education_courses_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.candidate_education_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.candidate_hobbies_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.candidate_languages_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.candidate_personal_info_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.candidate_project_achievements_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.candidate_project_technologies_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.candidate_projects_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.candidate_raw_data_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.candidate_soft_skills_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.candidate_technical_skills_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.candidate_volunteering_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.candidate_volunteering_responsibilities_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.candidate_work_experience_achievements_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.candidate_work_experience_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.candidate_work_experience_responsibilities_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.candidate_work_experience_technologies_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.job_applications_id_seq', 39, true);
...
SELECT pg_catalog.setval('public.job_posting_activities_id_seq', 81, true);
...
SELECT pg_catalog.setval('public.job_posting_daily_stats_id_seq', 205, true);
...
\unrestrict MGbBdyftuEKD6LSWdwDTdRJkqjV5HrDxcqWL5HJXgJSqeegYcfsauNcosd9ecKx
